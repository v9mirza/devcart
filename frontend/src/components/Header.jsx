  ...
  return (
    <header className="flex flex-col sm:flex-row gap-4 justify-between items-center w-full z-10">
      <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
        ...
        {/* Search */}
        <div className="relative ml-0 sm:ml-2 flex-1 sm:flex-none min-w-[220px]">
          <input
            type="text"
            placeholder="Search products..."
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            className="bg-white border border-stone-200/60 pl-5 pr-10 py-2.5 rounded-full text-sm font-medium w-full sm:w-72 focus:outline-none focus:ring-2 focus:ring-slate-300 transition-all shadow-sm"
          />
