    ...
    <header className="flex flex-col sm:flex-row gap-4 justify-between items-center w-full z-10">
      ...
      <div className="flex items-center gap-3">
        ...
        <button 
          ...
          className={`w-11 h-11 rounded-full flex items-center justify-center border transition-all shadow-sm active:scale-95 hover:scale-105 cursor-pointer relative ${
            wishlist.length > 0 
