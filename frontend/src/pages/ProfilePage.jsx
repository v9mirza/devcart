...
export default function ProfilePage() {
  ...
  if (loading) {
    return (
      <div className="card-panel flex items-center justify-center min-h-[280px]">
  ...
  if (!user) {
    return (
      <div className="card-panel text-center flex flex-col gap-6">
        <div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <Link to="/" className="w-full border border-zinc-200 bg-inset hover:bg-surface-hover text-slate-700 font-bold py-2.5 rounded-full text-center text-sm">
            Back to Store
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="card-panel flex flex-col gap-6 sm:gap-8">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 border-b border-zinc-100 pb-5">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="text-xs bg-inset text-stone-500 font-bold px-3 py-1 rounded-full uppercase tracking-wider border border-zinc-200">
            Profile
          </span>
        </div>
        <button
      ...
      <div className="section-muted flex flex-col sm:flex-row gap-6 items-center">
        ...
        <div className="text-center sm:text-left flex-1">
          ...
          <span className="inline-block text-[10px] font-extrabold bg-slate-100 text-slate-700 px-2.5 py-1 rounded-md mt-2 uppercase tracking-wider">
      ...
      {/* Account Settings */}
      <div className="section-muted flex flex-col gap-4">
        <div>
              ...
              <div key={order._id} className="border border-stone-200/60 rounded-2xl overflow-hidden">
                ...
                >
                  <div className="text-left">
                    ...
                    <span className="font-bold text-slate-900 font-mono text-xs truncate max-w-[180px] sm:max-w-none block">
                      {order._id}
                    </span>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-black text-slate-900 text-sm">${order.totalPrice || order.total}</span>
